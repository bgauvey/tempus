    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomCalendarRanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomCalendarRanges_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurrenceDaysOfWeek = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecurrenceEndType = table.Column<int>(type: "int", nullable: false),
                    ...
                    RecurrenceParentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IsRecurrenceException = table.Column<bool>(type: "bit", nullable: false),
                    RecurrenceExceptionDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ExternalCalendarId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExternalCalendarProvider = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomCalendarRanges_UserId",
                table: "CustomCalendarRanges",
                column: "UserId");
